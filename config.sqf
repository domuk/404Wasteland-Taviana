...
cityLocations = [];
cityList = [
		["ACityC_Kameni",250,"Kameni","city_Kameni"],
		["ACityC_Yaroslav",250,"Yaroslav","city_Yaroslav"],
		["ACityC_Ekaterinburg",250,"Ekaterinburg","city_Ekaterinburg"],
		["ACityC_Khotanousk",250,"Khotanousk","city_Khotanousk"],
		["ACityC_DugeSelo",250,"DugeSelo","city_DugeSelo"],
		["ACityC_Lyubol",250,"Lyubol","city_Lyubol"],
		["ACityC_Dalnogorsk",250,"Dalnogorsk","city_Dalnogorsk"],
		["ACityC_Sevastopol'",250,"Sevastopol'","city_Sevastopol'"],
		["ACityC_Gorka",250,"Gorka","city_Gorka"],
		["ACityC_Martin",250,"Martin","city_Martin"],
		["ACityC_Molotovsk",250,"Molotovsk","city_Molotovsk"],
		["ACityC_Dubovo",250,"Dubovo","city_Dubovo"],
		["ACityC_Sabina",250,"Sabina","city_Sabina"],
		["ACityC_Postoyna",250,"Postoyna","city_Postoyna"],
		["ACityC_Boye",250,"Boye","city_Boye"],
		["ACityC_Kopech",250,"Kopech","city_Kopech"],
		["ACityC_Byelov",250,"Byelov","city_Byelov"],
		["ACityC_StariSad",250,"StariSad","city_StariSad"],
		["ACityC_NobyBor",250,"NobyBor","city_NobyBor"],
		["ACityC_Prilep",250,"Prilep","city_Prilep"],
		["ACityC_Solibor",250,"Solibor","city_Solibor"],
		["ACityC_Etanovsk",250,"Etanovsk","city_Etanovsk"],
		["ACityC_Vinograd",250,"Vinograd","city_Vinograd"],
		["ACityC_Doriyanov",250,"Doriyanov","city_Doriyanov"],
		["ACityC_ChrveniGradok",250,"ChrveniGradok","city_ChrveniGradok"],
		["ACityC_Zabyela",250,"Zabyela","city_Zabyela"],
		["ACityC_Kustik",250,"Kustik","city_Kustik"],
		["ACityC_Nina",250,"Nina","city_Nina"],
		["ACityC_Lyepestok",250,"Lyepestok","city_Lyepestok"],
		["ACityC_Chernovar",250,"Chernovar","city_Chernovar"],
		["ACityC_Vedic",250,"Vedic","city_Vedic"],
		["ACityC_Bilfradnamoru",250,"Bilfradnamoru","city_Bilfradnamoru"],
		["ACityC_Krasnoznamensk",250,"Krasnoznamensk","city_Krasnoznamensk"],
		["ACityC_Komarovo",250,"Komarovo","city_Komarovo"],
		["ACityC_Repkov",250,"Repkov","city_Repkov"],
		["ACityC_Stangrad",250,"Stangrad","city_Stangrad"],
		["ACityC_Mitrovice",250,"Mitrovice","city_Mitrovice"],
		["ACityC_NoviDvor",250,"NoviDvor","city_NoviDvor"],
		["ACityC_StariDvor",250,"StariDvor","city_StariDvor"],
		["ACityC_Poljanka",250,"Poljanka","city_Poljanka"],
		["ACityC_Kryvoe",250,"Kryvoe","city_Kryvoe"],
		["ACityC_Tresnjevo",250,"Tresnjevo","city_Tresnjevo"],
		["ACityC_Branibor",250,"Branibor","city_Branibor"],
		["ACityC_Zhabkina",250,"Zhabkina","city_Zhabkina"],
		["ACityC_Topolka",250,"Topolka","city_Topolka"],
		["ACityC_Kosovo",250,"Kosovo","city_Kosovo"],
		["ACityC_Marina",250,"Marina","city_Marina"],
		["ACityC_Seven",250,"Seven","city_Seven"],
		["ACityC_Blato",250,"Blato","city_Blato"],
		["ACityC_Vodice",250,"Vodice","city_Vodice"]
];
