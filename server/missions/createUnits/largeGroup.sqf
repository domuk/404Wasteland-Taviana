...
//Sniper
_man5 = _group createunit ["Priest", [_pos select 0, (_pos select 1) - 30, 0], [], 0.5, "Form"];
...
//Grenadier
_man6 = _group createunit ["Priest", [_pos select 0, (_pos select 1) - 40, 0], [], 0.5, "Form"];
...
//Support
_man7 = _group createunit ["Priest", [(_pos select 0) - 40, _pos select 1, 0], [], 0.5, "Form"];
_man7 addMagazine "75Rnd_545x39_RPK";
_man7 addMagazine "75Rnd_545x39_RPK";
_man7 addWeapon "RPK_74";

//Grenadier
_man8 = _group createunit ["Priest", [_pos select 0, (_pos select 1) + 50, 0], [], 0.5, "Form"];
...
//Sniper
_man9 = _group createunit ["Priest", [_pos select 0, (_pos select 1) - 50, 0], [], 0.5, "Form"];
...
//Rifle_man
_man10 = _group createunit ["Priest", [_pos select 0, (_pos select 1) + 30, 0], [], 0.5, "Form"];
